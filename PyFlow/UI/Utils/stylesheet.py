...
class Colors:
    ...
    SelectionBlue = QtGui.QColor(66, 135, 245)
...
class editableStyleSheet:
    def __init__(self, appInstance=None):
        ...
        self.CanvasBgColor = QtGui.QColor(255, 255, 255)
        self.CanvasGridColor = QtGui.QColor(237, 237, 250)
        self.CanvasGridColorDarker = QtGui.QColor(237, 237, 250)
        self.DrawGrid = [1]
        ...
        self.LOD_Number = [4]
        self.NodeSwitch = [4]
        self.ConnectionSwitch = [4]
        self.PinSwitch = [4]
        self.CanvasSwitch = [4]

        self.ConnectionMode = [ConnectionTypes.Cubic]
        self.ConnectionRoundness = [2]
