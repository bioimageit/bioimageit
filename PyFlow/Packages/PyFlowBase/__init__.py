...
from PyFlow.Packages.PyFlowBase.FunctionLibraries.PandasLib import PandasLib
from PyFlow.Packages.PyFlowBase.FunctionLibraries.OmeroLib import OmeroLib
...
_FOO_LIBS = {
    ...
    PandasLib.__name__: PandasLib(PACKAGE_NAME),
    OmeroLib.__name__: OmeroLib(PACKAGE_NAME),
...
for pandasClass in PandasLib.classes.values():
    _NODES[pandasClass.__name__] = pandasClass

for omeroClass in OmeroLib.classes.values():
    _NODES[omeroClass.__name__] = omeroClass
...
_TOOLS = OrderedDict()
# _TOOLS[RunAllTool.__name__] = RunAllTool
# _TOOLS[RunTool.__name__] = RunTool
# _TOOLS[RunSelectedTool.__name__] = RunSelectedTool
# _TOOLS[ExportWorkflowTool.__name__] = ExportWorkflowTool
# _TOOLS[ClearAllTool.__name__] = ClearAllTool
# _TOOLS[ClearTool.__name__] = ClearTool
# _TOOLS[ClearSelectedTool.__name__] = ClearSelectedTool
