...
class Tool:
    ...
    def processData(self, args):
        ...
        command = ['simgspitfiredenoise2d', '-i', args.input_image, '-o', args.output_image, '-regularization', args.regularization, '-weighting', args.weighting, '-method', 'SV' if args.method == 'Sparse variation' else 'HV', '-padding', 'True' if args.padding else 'False', '-niter', 200]
