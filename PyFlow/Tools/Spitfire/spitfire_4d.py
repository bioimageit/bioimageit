...
class Tool:
    ...
    def processData(self, args):
        ...
        command = ['simgspitfiredenoise4d', '-i', args.input_image, '-o', args.output_image, '-regularization', args.regularization, '-weighting', args.weighting, '-method', args.method, '-niter', 200]
        command += ['-padding'] if args.padding else []
