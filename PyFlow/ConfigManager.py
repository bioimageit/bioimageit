...
class ConfigManager(object):
    ...
    def shouldRedirectOutput():
        redirectOutput = ConfigManager().getPrefsValue("PREFS", "General/RedirectOutput")
        return redirectOutput if isinstance(redirectOutput, bool) else redirectOutput == 'true'
