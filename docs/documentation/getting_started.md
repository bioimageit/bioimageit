...
![new workflow](/docs/documentation/images/new_workflow.png)
...
![List files path](/docs/documentation/images/list_files_path.png)
...
![List files path](/docs/documentation/images/dataframe_4_fish_images.png)
...
![Napari](/docs/documentation/images/napari.png)
...
![Convert image merge](/docs/documentation/images/convert_image_merge.png)
...
![Convert image results](/docs/documentation/images/convert_image_results.png)
...
![Extract 3 channels](/docs/documentation/images/extract_3_channels.png)
...
![2 Atlas nodes](/docs/documentation/images/2_atlas_nodes.png)
...
![Sam & connected components](/docs/documentation/images/sam_connected_components.png)
...
![Label overlaps](/docs/documentation/images/label_overlaps.png)
